...
: ${AMENT_CURRENT_PREFIX:="/home/ubuntu/rover_ws/src/install/rover_localization"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rover_localization/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rover_localization/environment/path.sh"
