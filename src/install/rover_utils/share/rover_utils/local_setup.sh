...
: ${AMENT_CURRENT_PREFIX:="/home/ubuntu/rover_ws/src/install/rover_utils"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rover_utils/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rover_utils/environment/path.sh"
