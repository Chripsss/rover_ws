...
public:
    ...
    {
        declare_parameter<std::string>("odom_topic", "halleffect_controller/odom");
        ...
        trajectory_pub_ = create_publisher<nav_msgs::msg::Path>("halleffect_controller/trajectory", 10);
    }
